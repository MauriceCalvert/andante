...
class SubjectCatalogue:
    ...
    def _build_catalogue(self, fugue: LoadedFugue) -> None:
        ...
        # Convert answer
        ans_intervals: tuple[int, ...] = degrees_to_intervals(degrees=fugue.answer.degrees)
        ...
        cs_intervals: tuple[int, ...] = degrees_to_intervals(degrees=fugue.countersubject.degrees)
